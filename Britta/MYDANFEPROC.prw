...
//No trecho abaixo, após finalizar a transmissão, grava na tabela SZA a hora do processamento.
    IF Type("_cOC") <> "U"
        ...
        Endif
    Endif
//No trecho acima, após finalizar a transmissão, grava na tabela SZA a hora do processamento.
