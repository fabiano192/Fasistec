...
#define STR0001 If( cPaisLoc $ "ANG|PTG", "Imprime a posiçğo dos títulos a receber relativo a data ba-", "Imprime a posicao dos titulos a receber relativo a data ba-" )
#define STR0002 If( cPaisLoc $ "ANG|PTG", "Se do sistema.", "se do sistema." )
#define STR0003 If( cPaisLoc $ "ANG|PTG", "Código de barras", "Zebrado" )
#define STR0004 If( cPaisLoc $ "ANG|PTG", "Administraçğo", "Administracao" )
#define STR0005 If( cPaisLoc $ "ANG|PTG", "Posiçğo Dos Títulos A Receber", "Posicao dos Titulos a Receber" )
...
#define STR0013 If( cPaisLoc $ "ANG|PTG", "Por Emissğo", "Por Emissao" )
#define STR0014 If( cPaisLoc $ "ANG|PTG", "Por Ven/bco", "Por Ven/Bco" )
#define STR0015 If( cPaisLoc $ "ANG|PTG", "Por Cód.cli.", "Por Cod.Cli." )
#define STR0016 If( cPaisLoc $ "ANG|PTG", "Banco/situaçğo", "Banco/Situacao" )
...
#define STR0025 If( cPaisLoc $ "ANG|PTG", " - Por Banco E Situaçğo", " - Por Banco e Situacao" )
...
#define STR0042 If( cPaisLoc $ "ANG|PTG", " - Por Emissğo", " - Por Emissao" )
...
#define STR0050 If( cPaisLoc $ "ANG|PTG", "Nğo imprimir tipos", "Nao imprimir tipos" )
#define STR0051 "Listar Abatimentos?"
#define STR0052 "Sim"
#define STR0053 If( cPaisLoc $ "ANG|PTG", "Nğo", "Nao" )
#define STR0054 "Loja - "
...
#define STR0062 If( cPaisLoc $ "ANG|PTG", "Emissğo", "Emissao" )
...
#define STR0084 "QUERY DE PESQUISA DE COMPENSAÇğO"
#define STR0085 "PESQUISA de COMPENSAÇğO"
#define STR0086 "Formato de impressğo tabela nğo suportado neste relatório"
...
#DEFINE SITUACA				10
#DEFINE VL_ORIG				11
#DEFINE VL_NOMINAL			12
#DEFINE VL_CORRIG			13
#DEFINE VL_VENCIDO			14
#DEFINE NUMBC				15
#DEFINE VL_JUROS			16
#DEFINE ATRASO				17
#DEFINE HISTORICO			18
...
±±³Fun‡…o    ³ BRI132  ³ Autor ³ Daniel Tadashi Batori ³ Data ³ 01.08.06 ³±±
...
Static Function ReportDef()
	...
	oReport := TReport():New("BRI132",STR0005,"FIN130",{|oReport| ReportPrint(oReport)},STR0001+STR0002)

	//oReport:DisableOrientation(.T.)// Opçğo de impressğo no formato Retrato desabilitada devido a nğo comportar mais informações.
	...
	*/
	...
	nTamBan	 := TamSX3("E1_PORTADO")[1] + 1
	_nTamSit := TamSX3("E1_SITUACA")[1] + 15 + 1
	//	nTamQueb := nTamCli + nTamTit + nTamBan + TamSX3("E1_TIPO")[1] + TamSX3("E1_NATUREZ")[1] + TamSX3("E1_EMISSAO")[1] +;
	nTamQueb := nTamCli + nTamTit + nTamBan +_nTamSit + TamSX3("E1_TIPO")[1] + TamSX3("E1_NATUREZ")[1] + TamSX3("E1_EMISSAO")[1] +;
...
//	_nTamPag += nTamCli
	...
	_nTamPag += nTamDte
	TRCell():New(oSection1,"BANCO",,'Bco',,nTamBan,.F.,,,,,,,.F.)  //"Bco St"
	_nTamPag += nTamBan
	TRCell():New(oSection1,"SITUACA",,'Sit. Banco',,_nTamSit,.F.,,,,,,,.F.)  //"St"
	_nTamPag += _nTamSit
...
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³A funcao estatica ReportDef devera ser criada para todos os  ³±±
±±³          ³relatorios que poderao ser agendados pelo usuario.           ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Retorno   ³Nenhum                                                       ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³ExpO1: Objeto Report do Relatório                            ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³   DATA   ³ Programador   ³Manutencao efetuada                          ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³          ³               ³                                             ³±±
...
Static Function ReportPrint(oReport)
	...
	// Para impressğo direta em PDF
	If oReport:nDevice == 6 
		nPageHeight := oReport:PageHeight() * 0.90 // 90% o total para nğo cortar na impressğo em papel
	...
	*/
	...
	While lContinua
		...
		*/
		...
		// na gestğo corporativa. Exempo SE1:     *
		...
		// Criaçğo de tabela temporária para armazernar a chave da FK7 para os títulos que possuem VA (FKD)
		If oTmp = Nil	
		...
		//Caso nğo haja nenhum registro de Valores Acessórios, evito chamar a rotina de cálculo de VA
		...
		Else
			...
			cSelect := "SELECT SE1.E1_FILIAL, " + SubStr(cCampos,2) + ", SE1.R_E_C_N_O_ " // NğO mudar a posiçğo do RECNO da query
		EndIf
		...
		If MV_PAR43 == 1
			If TcSrvType() != "AS/400"
				...
				Else
					cQryAux += " SELECT SE1.E1_FILIAL, " + SubStr(cCampos,2) + ", SE1.R_E_C_N_O_ " // NğO mudar a posiçğo do RECNO da query
				Endif
		...
		While !Eof() .And. SE1->E1_FILIAL == cFilSE1 .And. &cCond1
			...
			While !Eof() .And. SE1->E1_FILIAL == cFilSE1 .And. &cCond2 == cCarAnt
				...
				//³ crédito ou digitaçğo para impressğo. 							   ³
				...
				If mv_par20 == 1	// Considera Data Base
					...
					aScan( aRecSE1Cmp , { |x| x[1] == SE1->( R_E_C_N_O_ )} ) > 0
						proclogatu("INICIO",STR0085) //"PESQUISA DE COMPENSAÇğO DE MULTI-FILIIAS"
						...
						nDecs+1),nDecs)
						proclogatu("FIM",STR0085)//Log pesquisa de compensaçğo
					EndIf
					...
					If cPaisLoc=="BRA"
						...
						!(SE1->E1_TIPO $ MVIRF).and. !(SE1->E1_TIPO $ MVABATIM) .AND. ( (SA1->(A1_RECIRRF) $ "1 " ) .And. SA1->A1_TPESSOA == 'EP' ) )
							...
							//tratamento para emissğo correta do saldo do título, quando o PCC+IR estiver na baixa e for realizado baixa parcial.
							If nRecSA1 > 0
								SE5->(DbSetOrder(7))
								cSeq := "01" 				
				...
				If ! SE1->E1_TIPO $ MVABATIM	+"/"+MVFUABT
					...
					!( MV_PAR20 == 2 .And. nSaldo == 0 )  	// deve olhar abatimento pois e zerado o saldo na liquidacao final do titulo
						...
						//Busca as informações para alimentar a array aTitImp utilizando a funçğo F130RETIMP
						If lExistAba						
							aTitImp:= f_F130RETIMP(cFilNat)
						Else				        
							aTitImp:= {}
						EndIf
						...
						aScan(aAbatBaixa, {|x| ALLTRIM(x[2])==ALLTRIM(SE1->(E1_PREFIXO+E1_NUM+E1_PARCELA+E1_TIPO+E1_CLIENTE+E1_LOJA)) }) > 0
							...
							If mv_par33 != 1  //somente deve considerar abatimento no saldo se nao listar
								...
								Endif
							Else
								// Subtrai o Abatimento caso o mesmo já tenho sido baixado ou nğo esteja listado no relatorios
				...
				aDados[EMISSAO] := Iif(lDvc, SE1->E1_EMISSAO, f_F130Dtano2(SE1->E1_EMISSAO))
				aDados[VENCTO] := Iif(lDvc, SE1->E1_VENCTO, f_F130Dtano2(SE1->E1_VENCTO))
				aDados[VENCREA] := Iif(lDvc, SE1->E1_VENCREA, f_F130Dtano2(SE1->E1_VENCREA))
				lVl_Corr := .T.
				...
				If mv_par20 == 1  //Recompoe Saldo Retroativo
					...
					IF !Empty(SE1->E1_BAIXA)
						If SE1->E1_BAIXA <= mv_par36 .Or. !Empty( SE1->E1_PORTADO )
							...
							aDados[BANC] := SE1->E1_PORTADO
						EndIf
					Else
						//Titulo nğo foi Baixado e foi transferido para Carteira e Data Movimento e menor
				...
				aDados[SITUACA] := SE1->E1_SITUACA+'-'+Alltrim(Posicione("FRV",1,xFilial("FRV")+SE1->E1_SITUACA,"FRV_DESCRI"))
				...
				If dDataBase > dVencRea	//vencidos
					...
					If !( SE1->E1_TIPO $ MVRECANT + "|" + MV_CRNEG ) .And. ( lFJurCst .Or. !Empty(SE1->E1_VALJUR) .Or. !Empty(SE1->E1_PORCJUR) .Or. lClcMultLj )
						...
						ElseIf AllTrim(SE1->E1_ORIGEM) == "FINI055" //Integraçğo TIN x PROTHEUS
							If lMvJurTin
				...
				If mv_par19 == 1 //1 = Analitico - 2 = Sintetico 18
					...
					// pois se cliente customizar relatorio com campo memo, o conteudo nğo é exibido				
			...
			IF nTit5 > 0 .And. nOrdem != 2 .And. nOrdem != 10 .And. mv_par19 == 2 //1 = Analitico - 2 = Sintetico
				oReport:SkipLine()
				f_SubTot130R(nTit0,nTit1,nTit2,nTit3,nTit4,nOrdem,cCarAnt,nTotJur,nDecs,oReport,,oSection2)
				nTotReg++
			ElseIf lImpSintTbl
				oReport:SkipLine()
				oReport:ThinLine()			
			...
			//MV_PAR33 = 2 (Nğo Listar) os títulos de abatimento nğo serğo impressos,porém do valor a receber serğo diminuidos os abatimentos.
...
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄ-ÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
Static Function f_SubTot130R(nTit0,nTit1,nTit2,nTit3,nTit4,nOrdem,cCarAnt,nTotJur,nDecs,oReport,aDados,oSection)
...
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄ-ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe e ³ TotGer130R()															   ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄ-ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³																				   ³±±
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄ-ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ Generico																	   ³±±
...
Static Function HabiCel(oReport, lMultNat)
	...
	If mv_par19 == 1 //1 =  Analitico - 2 = Sintetico
		If !lMultNat .And. !lImpSintTbl
			...
			oSection1:Cell("SITUACA"   ):HideHeader()
...
±±ğÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄ´±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function f_Fr130Cond(cTipos)
	Local lRet			:= .T.
	Local dDtContab
	Local aArea			:= GetArea()
	Local cSelQry		:= ""
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function f_F130RETIMP(cFiltro)
...
Static Function f_FTITPAI()
	...
	cQuery += " AND E1_TIPO NOT IN " + f_F130MontaIn()
	cQuery += " AND D_E_L_E_T_  = ' ' "
...
Static Function FTITRAPAI(cTITPAI)
	...
	Local nTamTipo := 0
	Local cTipo    := ""
	//Controla o Pis Cofins e Csll na RA (1 = Controla retençğo de impostos no RA; ou 2 = Nğo controla retençğo de impostos no RA(default))
...
Static Function HashNatur(cTipoIn)
	...
	If !lTemCli
		...
		cQuery += "    AND SE1.E1_TIPO IN "  + f_F130MontaIn(@cTipoIn)
		cQuery += "    AND SE1.D_E_L_E_T_ = ' ' "
...
Formata a expressğo para IN ou NOT IN
...
/*/
//-------------------------------------------------------------------
Static Function f_F130MontaIn(cTipoIn)
...
Funçğo para transformar o ano em 2 caracteres.
...
/*/
//-------------------------------------------------------------------
Static Function f_F130Dtano2(cDataX)
