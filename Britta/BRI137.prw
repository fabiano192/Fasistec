...
Static Function BRI137A()
	...
	_aEmp := {"500129067113009495","500229067113009495","500629067113033280","500729067113027809"}
	...
	_oProcess:IncRegua1("Consultando NFs e gravando em Tabela Temporária...")
	...
	For F := 1 to Len(_aEmp)
		...
		_oProcess:IncRegua2('Processando a empresa '+Left(_aEmp[F],4)+'.')
...
// TCSetConn(advConnection())	//-TCSetConn eh igual ao dbSelectArea
	...
	If _lTRB
		...
		While TRB->(!EOF())
			...
			//Monitor Cte.
			TMSAE70(1,"01",,,,,,.T.)
			// TMSAE70(1,DTP->DTP_FILORI,DTP->DTP_LOTNFC,,,,,.T.)
		ENDDO
