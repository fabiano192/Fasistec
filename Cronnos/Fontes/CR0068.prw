...
Data		:	02/02/2015
Descrição	:	Cadastro de Programação EDI - Tabela SZ4
*/
...
User Function CR0068()
	...
	oBrowse:SetDescripton("Cadastro de Programação EDI")
...
Static Function ModelDef()
	...
	oModel:SetDescription( 'Modelo de Dados do Cadastro de Programação EDI' )

	oModel:SetPrimaryKey({})

	//Adiciona Descricao do Componente do Modelo de Dados
	oModel:GetModel( 'MODEL_CR0068' ):SetDescription( 'Formulario de  Cadastro de Programação EDI' )
