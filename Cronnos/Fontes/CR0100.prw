...
User Function CR0100()
	...
	@ 34,18 SAY "Programa CR0100.PRW                                					" 	OF oDlg PIXEL

	DEFINE SBUTTON FROM 055,030 TYPE 5 ACTION (Pergunte("CR0100",.T.)) 	ENABLE Of oDlg
	...
	If _nOpc == 1
		...
		Private _bAcao01   := {|_lFim| CR100_A(@_lFim) }
...
//	MemoWrite("D:\CR0100.TXT",_cQuery)
