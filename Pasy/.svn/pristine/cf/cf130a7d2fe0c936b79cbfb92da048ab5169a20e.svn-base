...
Fonte criado com base no fonte padrão PA0248
@author Fabiano
@since 24/04/2017
@version undefined
@type function
/*/
User Function PA0248()
...
Static Function ReportDef()
	...
	oReport := TReport():New("PA0248",STR0018,"MR780A", {|oReport| ReportPrint(oReport,cAliasSD1,cAliasSD2,cAliasSA1)},STR0019 + " " + STR0020)	// "Estatisticas de Vendas (Cliente x Produto)"###"Este programa ira emitir a relacao das compras efetuadas pelo Cliente,"###"totalizando por produto e escolhendo a moeda forte para os Valores."
	oReport:SetPortrait()
