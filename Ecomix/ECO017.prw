...
User Function ECO017(_cSched)
    ...
    Else
        ...
        @ 35,167 BUTTON "Parametros" SIZE 036,012 ACTION (Pergunte("ECO017",.T.)) 	OF oDlg PIXEL
        ...
        If _nOpc = 1
            ...
            If cEmpAnt != "16"
                Private _bAcao01       := {|_lFim| ECO017A(@_lFim) }    /// CONFORME CONTABILIDADE VISAO 001
                Private _cTitulo01 := 'Processando...'
                Processa( _bAcao01, _cTitulo01, _cMsg01, _lAborta01 )

                Private _bAcao01       := {|_lFim| ECO017B(@_lFim) }    /// CONFORME SZQ VISAO 003
                Private _cTitulo01 := 'Processando...'
                Processa( _bAcao01, _cTitulo01, _cMsg01, _lAborta01 )

                Private _bAcao01       := {|_lFim| ECO017C(@_lFim) }    /// CONFORME SZQ VISAO 004
                Private _cTitulo01 := 'Processando...'
                Processa( _bAcao01, _cTitulo01, _cMsg01, _lAborta01 )

                Private _bAcao01       := {|_lFim| ECO017D(@_lFim) }    /// CONFORME SZQ VISAO 005 ---- BOLETIM DE PRODUCAO
                Private _cTitulo01 := 'Processando...'
                Processa( _bAcao01, _cTitulo01, _cMsg01, _lAborta01 )
