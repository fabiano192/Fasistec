...
cSigla:= SuperGetMv( "ECO_SIGLA" , .F. , , QRYSF2->F2_FILIAL ) //  getNewPar('ECO_SIGLA','ECO ')

ZZD->ZZD_SIGLA  := cSigla

If SC5->C5_XOPER == "V"
	ZZD->ZZD_EMIORI := SC5->C5_EMISSAO
Endif
...
Static Function GERAMOVR()
	...
	// ZZD->ZZD_HRSAID	    := QRYSF2->F2_HORA             // HORA DE SAIDA DA NF
	// Ricardo 28/06/2020
	zzd->zzd_hrsaid:=posicione('ZR1',1,xfilial('ZR1')+qrysc5->c5_num,'zr1_hrsaid')
