...
Static Function GeraFOR(_cFil,_cCNPJ,_cCod,_cLoja,_cAliasSA2)
	...
	(_cAliasSA2)->A2_BANCO   := TCLI->FORBCO
	(_cAliasSA2)->A2_AGENCIA := TCLI->FORAGE
	(_cAliasSA2)->A2_XDVAGEN := TCLI->FORDAG
	(_cAliasSA2)->A2_NUMCON  := TCLI->FORCTA
	(_cAliasSA2)->A2_XDVCON  := TCLI->FORDCT
	(_cAliasSA2)->(MsUnLock())
