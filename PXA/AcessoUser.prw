...
Define MsDialog oDlg Title "Acesso de Usuários" From aSize[7],0 to aSize[6],aSize[5] of oMainWnd PIXEL //oMainWnd:nTop+125,oMainWnd:nLeft+5 To oMainWnd:nBottom-60,oMainWnd:nRight-10 Of oMainWnd Pixel
...
//
If aColPrint[3]
   TRCell():New(oSecao,"MENU"   ,"WKACESSO","Menu"            ,""            ,15,,,"LEFT")
EndIf
//
If aColPrint[4]
...
//
If aColPrint[6]
   TRCell():New(oSecao,"ACESSO" ,"WKACESSO","Acesso"          ,""            ,15,,,"LEFT")
EndIf
//
If aColPrint[7]
