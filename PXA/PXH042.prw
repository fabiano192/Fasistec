...
±±ºPrograma  ³ PXH042   ºAutor  ³Marcio Aflitos      º Data ³  08/26/10   º±±
...
USER FUNCTION PXH042(cRotName, _nOper, lExibeMsg)
	...
	IF Alltrim(UPPER(cRotName)) == 'MATA456' .And. _nOper == 0 		// Botão Manual (Lib Cred/Est)
		_nOper := 4 // ZZZ_ALTERA
	EndIf
