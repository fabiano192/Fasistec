...
cQuery +="	   (CASE CT2_DC             WHEN '2'      THEN CT2_CCC    ELSE CT2_CCD    END) D3_CC, "+CRLF
cQuery +="	   (CASE CT2_DC             WHEN '2'	  THEN CT2_ITEMC  ELSE CT2_ITEMD  END) D3_ITEMCTA, "+CRLF
cQuery +="	   (CASE CT2_DC             WHEN '2'	  THEN CT2_CLVLCR ELSE CT2_CLVLDB END) D3_CLVL, "+CRLF
