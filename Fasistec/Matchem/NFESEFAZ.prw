...
Private _cEst      := "" 
Private _cTipoNf   := ""
Private _nICMDes   := 0 // Variável Utilizada na Fórmula para imprimir o Valor do ICMS Destino
If FunName() == "SPEDNFSE"
...
//	cString += '<UFDesemb>'+"SP"+ '</UFDesemb>'
	cString += '<UFDesemb>'+Alltrim(SM0->M0_ESTCOB)+ '</UFDesemb>'
