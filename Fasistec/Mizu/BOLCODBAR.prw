...
±±³Programa  ³  BOLLASER³ Autor ³ Sergio Andre			³ Data ³ 01/02/05 ³±±
...
//Private aConta		:=  {{"01"  ,"0045001"},{"10"  ,"0048790"},{"11"  ,"0048760"},{"12"  ,"0010545"},{"20","0045003"},{"30","0045005"},{"40","0029070"}}
//Private aConta02	:=  {{"0201","0029070"},{"0203","0029070"},{"0210","0029070"},{"0211","0029070"},{"0213","0029070"},{"0214","0029070"},{"0215","0029070"},{"0216","0029070"},{"0218","0029070"},{"0220","0029070"},{"0221","0029070"},{"0222","0029070"},{"0223","0029070"},{"0225","0029070"},{"0226","0029070"},{"0231","0029070"}}
...
Do While !TRBXXX->(EOF())
	...
	IF lBcoNaoOk
		ApMsgInfo("O código de banco informado no cadastro do cliente não é 237. Esta rotina imprime apenas boletos para o bradesco. Altere para 237 o banco do cliente e você conseguirar imprimir por aqui.",TRBXXX->(E1_CLIENTE+E1_LOJA+"-"+E1_PREFIXO+E1_NUM+E1_PARCELA) )
		TRBXXX->(dbSkip())
		LOOP
	ENDIF
