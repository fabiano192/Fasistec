...
Static Function EXPDADOS()
	...
	Local _aTabelas    := {'SF2'}
	// Local _aTabelas := {'CT1','CT2','SA1','SA2','SB1','CTT','SA6','SE1','SE2'}
					...
					If CriarDTC(_cTab,_cKey1)
						...
						While TCLI->(!EOF()) .And. _cKey1 == Alltrim(cValToChar(TCLI->EMP))
							...
							While TCLI->(!EOF()) .And. &(_cChave)
								...
								GeraCli("TRM",_cFil,_cCod,_cLoja,_cCNPJ)
					...
					If CriarDTC(_cTab,_cKey1)
						...
						While TFOR->(!EOF()) .And. _cKey1 == Alltrim(cValToChar(TFOR->EMP))
							...
							While TFOR->(!EOF()) .And. &(_cChave)
								...
								GeraFor("TRM",_cFil,_cCod,_cLoja,_cCNPJ)
/*
								TRM->(RecLock("TRM",.T.))
								TRM->A2_FILIAL  := _cFil
						...
						While TREC->(!EOF()) .And. _cKey1 == Alltrim(cValToChar(TREC->CODCOLIGADA))
							...
							Else
								...
								If _nReg > 0
									...
									GeraCli("TRM3",_cFil,_cCod,_cLoja,_cCNPJ)

									_cCodCli := _cCod
									_cLojCli := _cLoja
									_cNomCli := UPPER(NOACENTO(TCLI->NOME))
...
//E1_MESBASE E1_ANOBASE E1_PLNUCOB   E1_CODEMP E1_CODINT E1_MATRIC E1_TXMOEDA             E1_ACRESC              E1_SDACRES             E1_DECRESC             E1_SDDECRE             E1_MULTNAT E1_MSFIL E1_MSEMP E1_PROJPMS  E1_NRDOC                                           E1_MODSPB E1_EMITCHQ                               E1_IDCNAB  E1_PLCOEMP   E1_PLTPCOE E1_CODCOR E1_PARCCSS E1_CODORCA E1_CODIMOV   E1_FILDEB E1_NUMRA        E1_NUMSOL E1_INSCRIC E1_SERREC                                     E1_DATAEDI E1_CODDIG                                        E1_CHQDEV E1_LIDESCF E1_VLBOLSA             E1_NUMCRD  E1_VLFIES              E1_DEBITO            E1_CCD    E1_ITEMD  E1_CLVLDB E1_CREDIT            E1_CCC    E1_ITEMC  E1_CLVLCR E1_DESCON1             E1_DESCON2             E1_DTDESC3 E1_DTDESC1 E1_DTDESC2 E1_VLMULTA             E1_DESCON3             E1_MOTNEG E1_SABTPIS             E1_SABTCOF             E1_SABTCSL             E1_FORNISS E1_PARTOT E1_SITFAT E1_BASEPIS             E1_BASECOF             E1_BASECSL             E1_VRETISS             E1_PARCIRF E1_SCORGP E1_FRETISS E1_TXMDCOR             E1_SATBIRF             E1_TIPREG E1_CONEMP    E1_VERCON E1_SUBCON E1_VERSUB E1_PLLOTE  E1_PLOPELT E1_CODRDA E1_FORMREC E1_BCOCLI E1_AGECLI E1_CTACLI  E1_PARCFET E1_FETHAB              E1_MDCRON E1_MDCONTR      E1_MEDNUME E1_MDPLANI E1_MDPARCE E1_MDREVIS E1_NUMMOV E1_PREFORI E1_NODIA   E1_TITPAI                                          E1_DOCTEF            E1_MDMULT              E1_JURFAT                                          E1_MDBONI              E1_MDDESC              E1_RELATO E1_BASEINS             E1_MULTDIA             E1_NFELETR           E1_RETCNTR             E1_NUMCON            E1_TURMA             E1_IDLAN               E1_NSUTEF    E1_SABTIRF             E1_IDAPLIC             E1_PROCEL              E1_NOPER               E1_SERVICO E1_DIACTB E1_IDBOLET             E1_VRETIRF             E1_BASEISS             E1_VLBOLP              E1_APLVLMN E1_LTCXA   E1_NUMINSC             E1_CODISS E1_SEQBX D_E_L_E_T_ R_E_C_N_O_  R_E_C_D_E_L_ E1_VLMINIS E1_TPDP                E1_PARTPDP E1_CODIRRF E1_USERLGI        E1_USERLGA        E1_YFORBKP E1_NUMPRO  E1_INDPRO E1_PRISS               E1_PRINSS              E1_PARCFAC E1_FACS                E1_PARCFAB E1_FABOV               E1_PERLET E1_CHAVENF   E1_PRODUTO      E1_FAMAD               E1_PARCFAM E1_FMPEQ               E1_PARCFMP E1_TPDESC E1_FUNDESA             E1_IMAMT               E1_FASEMT              E1_PARFUND E1_PARIMA E1_PARFASE E1_CODRET E1_CTRBCO                                          E1_IDMOV   E1_BOLETO E1_DESCJUR             E1_CCUSTO E1_CDRETCS E1_CDRETIR E1_CLVL   E1_ITEMCTA E1_TPESOC E1_CNO E1_CONHTL                        E1_TCONHTL E1_SDOC E1_SDOCREC E1_VRETBIS             E1_CODSERV E1_BTRISS              E1_RATFIN
						...
						While TPAG->(!EOF()) .And. _cKey1 == Alltrim(cValToChar(TPAG->CODCOLIGADA))
							...
							Else
								...
								If _nReg > 0
									...
									GeraFor("TRM4",_cFil,_cCod,_cLoja,_cCNPJ)

									_cCodCli := _cCod
									_cLojCli := _cLoja
									_cNomCli := UPPER(NOACENTO(TFOR->NOME))
		...
		ElseIf _cTab = 'SD2'
			...
			_cQry := " SELECT * FROM DADOSRM..TITMMOV A " +CRLF
			_cQry += " WHERE RTRIM(A.CODCOLIGADA)+RTRIM(A.CODFILIAL) IN ('91','93','101','103','104','111','113')" +CRLF
			_cQry += " ORDER BY A.CODCOLIGADA,A.CODFILIAL " +CRLF
				...
				While TNFITEM->(!EOF())
					...
					If CriarDTC(_cTab,_cKey1)
						...
						While TNFITEM->(!EOF()) .And. _cKey1 == Alltrim(cValToChar(TNFITEM->CODCOLIGADA))
							...
							TRM->F2_EST     := _cUF
							TRM->F2_VALBRUT := TNFITEM->VALORLIQUIDO
							TRM->F2_VALMERC := TNFITEM->VALORBRUTO
							TRM->F2_PREFIXO := Alltrim(TNFITEM->SERIE)
							TRM->F2_CLIENT  := _cCodCli
							TRM->F2_LOJENT  := _cLojCli
							TRM->F2_CHVNFE  := Alltrim(TNFITEM->CHAVEACESSONFE)
							// TRM->F2_CODNFE  := Alltrim(TNFITEM->CHAVEACESSONFE)
							TRM->F2_FRETE   := TNFITEM->VALORFRETE
...
Static Function GeraCli(_cAlias,_cFil,_cCod,_cLoja,_cCNPJ)
	...
	(_cAlias)->A1_NOME    := UPPER(NOACENTO(TCLI->NOME))
	(_cAlias)->A1_NREDUZ  := UPPER(NOACENTO(TCLI->NOMEFANTASIA))
	(_cAlias)->A1_END     := UPPER(NOACENTO(Alltrim(TCLI->RUA)))+" "+UPPER(NOACENTO(ALLTRIM(TCLI->NUMERO)))
	(_cAlias)->A1_COMPLEM := UPPER(NOACENTO(Alltrim(TCLI->COMPLEMENTO)))
	// (_cAlias)->A1_TIPO    := TCLI-> ????
	(_cAlias)->A1_EST     := TCLI->CODETD
	(_cAlias)->A1_COD_MUN := TCLI->CODMUNICIPIO
	(_cAlias)->A1_MUN     := UPPER(NOACENTO(Alltrim(TCLI->CIDADE)))
	(_cAlias)->A1_BAIRRO  := UPPER(NOACENTO(Alltrim(TCLI->BAIRRO)))
...
Static Function GeraFor(_cAlias,_cFil,_cCod,_cLoja,_cCNPJ)
	...
	(_cAlias)->A2_NOME    := UPPER(NOACENTO(TFOR->NOME))
	(_cAlias)->A2_NREDUZ  := UPPER(NOACENTO(TFOR->NOMEFANTASIA))
	(_cAlias)->A2_END     := UPPER(NOACENTO(Alltrim(TFOR->RUA)))+" "+UPPER(NOACENTO(ALLTRIM(TFOR->NUMERO)))
	(_cAlias)->A2_COMPLEM := UPPER(NOACENTO(Alltrim(TFOR->COMPLEMENTO)))
	(_cAlias)->A2_TIPO    := TFOR->PESSOAFISOUJUR
	(_cAlias)->A2_EST     := TFOR->CODETD
	(_cAlias)->A2_COD_MUN := TFOR->CODMUNICIPIO
	(_cAlias)->A2_MUN     := UPPER(NOACENTO(Alltrim(TFOR->CIDADE)))
	(_cAlias)->A2_BAIRRO  := UPPER(NOACENTO(Alltrim(TFOR->BAIRRO)))
