...
// codigo, loja nome, nf, serie, emissao. (remetente), (codigo, loja, nome, numero cte, data cte, valor do frete)
	...
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Placa"				, 1,1,.F.) // 17/02/20
	
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Emissão NF"			, 1,4,.F.)
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Valor NF"  			, 3,2,.T.)

	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Qtde Litros" 		, 3,2,.T.)
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Peso Líquido" 		, 3,2,.T.)
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Valor Unit Diesel"	, 3,2,.T.)
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Valor Total Diesel" , 3,2,.T.)
	_oFwMsEx:AddColumn( _cWorkSheet, _cTable , "Valor Frete Bruto"	, 3,2,.T.)
	...
	While SM0->(!EOF())
		...
		Endif
/*
		If MV_PAR03 < _cEmp .Or. MV_PAR04 > _cEmp
			SM0->(dbSkip())
			Loop
		Endif
*/
		_cQuery := " SELECT DT6_DOC,DT6_SERIE,DT6_DATEMI,DT6_VALFRE,DT6_CLIREM,DT6_LOJREM,A1R.A1_NREDUZ AS NOMREM,DT6_CLIDES,DT6_LOJDES,A1D.A1_NREDUZ AS NOMDES,DTC_NUMNFC,DTC_SERNFC, " +CRLF
		_cQuery += " DT6_VALMER,DTC_DATENT, DTC_YPLACA, DTC_YQTLIT, DTC_PESO, DTC_YVLUNI,DTC_YVLTOT,DTC_YFRCHE " +CRLF
...
//    	      Grupo/Ordem/Pergunta    				/perg_spa /perg_eng/Variavel/Tipo/Tamanho/Decimal/Presel/GSC/Valid     /Var01     /Def01    	/defspa1/defeng1/Cnt01  /Var02/Def02/Defspa2/defeng2/Cnt02/Var03/Def03/defspa3/defeng3/Cnt03/Var04/Def04/defspa4/defeng4/Cnt04/Var05/Def05/deefspa5/defeng5/Cnt05/F3
	...
	U_CRIASX1(_cPerg,"03" ,"Transportadora De  ?"	,""       ,""      ,"mv_ch3","C" ,02     ,0      ,0     ,"G",""        ,"MV_PAR03",""        	,""     ,""     ,""     ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""      ,""     ,""   ,"SM0MRP")
	U_CRIASX1(_cPerg,"04" ,"Transportadora Ate ?"	,""       ,""      ,"mv_ch4","C" ,02     ,0      ,0     ,"G",""        ,"MV_PAR04",""        	,""     ,""     ,""     ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""      ,""     ,""   ,"SM0MRP")
	U_CRIASX1(_cPerg,"05" ,"Origem De  ?"			,""       ,""      ,"mv_ch5","C" ,03     ,0      ,0     ,"G",""        ,"MV_PAR05",""        	,""     ,""     ,""     ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""      ,""     ,""   ,"")
	U_CRIASX1(_cPerg,"06" ,"Origem Ate ?"			,""       ,""      ,"mv_ch6","C" ,03     ,0      ,0     ,"G",""        ,"MV_PAR06",""        	,""     ,""     ,""     ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""     ,""     ,""   ,""   ,""   ,""      ,""     ,""   ,"")
